...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_nnm7oig",  // Replace with your EmailJS Service ID
        "template_dxrwwui",  // Replace with your EmailJS Template ID
        form.current,
        "0gACZtqU3CPW8hZ2p"  // Replace with your EmailJS Public Key
      )
      .then(
        () => {
          setIsSent(true);
